...
/* package bank-simulation-0.1.1 */
#ifndef VERSION_bank_simulation
#define VERSION_bank_simulation "0.1.1"
#endif /* VERSION_bank_simulation */
#ifndef MIN_VERSION_bank_simulation
#define MIN_VERSION_bank_simulation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 1)
#endif /* MIN_VERSION_bank_simulation */
...
#define CURRENT_COMPONENT_ID "bank-simulation-0.1.1-9O58Ss63O4gEssKsBMuzpQ-bank-simulation"
